...
public class Plastic extends Element {
    ...
    // PROPERTIES //
        ...
        Color ELEMENT_COLOR = new Color(191, 224, 194);
    ...
    public void update(FallingSandGame game, int x, int y) {
        ...
        if (game.getHeatAt(x, y) > 350) {
            ELEMENT_COLOR = new Color(222, 250, 225);
            ...
            ELEMENT_COLOR = new Color(171, 220, 174);;
        }
