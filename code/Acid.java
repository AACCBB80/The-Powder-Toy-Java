...
public class Acid extends Element {
    ...
    public void update(FallingSandGame game, int x, int y) {
        ...
        if ((random.nextInt(2) == 0)) {
            ...
            game.setElementAt(x+temp1, y+temp2, null);
            game.addHeatAt(x+temp1, y+temp2, 10);
